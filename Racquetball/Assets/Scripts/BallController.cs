...
public class BallController : MonoBehaviour
{
    ...
    [SerializeField] private float bounceForceIncrease = 7f; // Force multiplier when bouncing off the player
    ...
    private void OnCollisionEnter(Collision collision)
    {
        if (collision.gameObject == player.gameObject)
        {
            ...
            Physics.IgnoreCollision(collision.collider, player.GetComponent<Collider>());
        }
